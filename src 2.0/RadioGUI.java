...
public class RadioGUI extends javax.swing.JFrame {
    ...
    private void cargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cargarActionPerformed
        // TODO add your handling code here:
        if (lista.getSelectedItem().toString().equals("1")) {
...
}else if (lista.getSelectedItem().toString().equals("2")) {
        
             izquierdaFm.setEnabled(false);
        derechaFm.setEnabled(false);
        izquierdaAm.setEnabled(false);
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("3")) {
        ...
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("4")) {
        ...
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("5")) {
        ...
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("6")) {
        ...
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("7")) {
            izquierdaFm.setEnabled(false);
        derechaFm.setEnabled(false);
        izquierdaAm.setEnabled(false);
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("8")) {
        ...
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("9")) {
        ...
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("10")) {
        ...
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("11")) {
        ...
        derechaAm.setEnabled(false);
        label2.setText("Para cambiar de emisora presione el boton de am/fm");
}else if (lista.getSelectedItem().toString().equals("12")) {
